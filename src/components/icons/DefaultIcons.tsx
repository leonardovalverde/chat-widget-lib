...
/**
 * Default minimize icon
 */
export const MinimizeIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    width="12"
 ...
 */
export const MaximizeIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    width="12"
...
/**
 * Default bot icon component
 */
export const BotIcon: React.FC<{ className?: string }> = ({ className }) => (
  <div
    className={`w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg flex items-center justify-center text-white text-lg ${className}`}
  >
    🤖
  </div>
);
